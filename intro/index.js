...
*/
var userNames = ["Tejas", "Himanshu", "Hemanth", "Bobby", "sachin"]; // Homogenous
console.log(userNames);
var userNames1 = ["Tejas", "Himanshu", "Hemanth", "Bobby", "sachin"]; // Homogenous
console.log(userNames1);
var data = ["Tejas", "Java Trainer", 10];
console.log(data);
var data1 = ["Tejas", "Java Trainer", 10];
console.log(data1);
var x = ["Tejas", 10, null, undefined, true];
console.log(x);
var y = ["Tejas", 10, null, undefined, true];
console.log(y);
var empnames = ["Tejas", "Himanshu", "Hemanth", "Bobby", "Indhuja", "Divakar"];
//                  0         1           2         3         4         5
...
for (var i in empnames) {
    console.log(i);
}
//? for of
// It will iterate based on values.
for (var _i = 0, empnames_1 = empnames; _i < empnames_1.length; _i++) {
    var i = empnames_1[_i];
    console.log(i);
}
// forEach 
